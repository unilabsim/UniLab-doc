...
- [G1 Motion Tracking](4-tasks/2-g1-motion-tracking.md)：训练前先确认 motion 资产和 replay
- [Sharpa Inhand](4-tasks/4-sharpa-inhand.md)：scale / grasp cache / DR 边界更敏感
- [Go2 Rough Terrain](4-tasks/5-go2-rough-terrain.md)：常见的是 mass、COM、friction、push

## 深入文档

- 需要更底层 contract 时，去看 developer 文档里的 {doc}`Domain Randomization Contract </zh_CN/2-developer_guide/4-domain-randomization-contract>`

## Navigation

- Index: [Documentation](../0-index.md)
- Previous: [Algorithms](4-algorithms.md)
- Next: [任务索引](4-tasks/1-task-index.md)
