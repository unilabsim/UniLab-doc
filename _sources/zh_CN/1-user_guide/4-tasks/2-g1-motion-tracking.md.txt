...
> {doc}`迁移指南 </zh_CN/2-developer_guide/6-motion-asset-migration>`。
...
- 通用训练规则：看 [03 训练指南](../3-training.md)
- 算法选择：看 [04 算法说明](../4-algorithms.md)
- 任务总索引：看 [D 任务索引](1-task-index.md)

## Navigation

- Index: [Documentation](../../0-index.md)
- Previous: [任务索引](1-task-index.md)
- Next: [Allegro Inhand](3-allegro-inhand.md)
