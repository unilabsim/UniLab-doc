...
本文不是用户使用指南。当前可运行的 rough terrain 用法见 {doc}`Go2 Rough Terrain </zh_CN/1-user_guide/4-tasks/5-go2-rough-terrain>`。
...
- Related: [RL Infrastructure 开发标准](1-development-standard.md)
- Related: {doc}`Go2 Rough Terrain </zh_CN/1-user_guide/4-tasks/5-go2-rough-terrain>`
