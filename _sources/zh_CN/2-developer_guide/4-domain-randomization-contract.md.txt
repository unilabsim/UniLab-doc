...
本页记录 domain randomization 的开发者 contract、MuJoCo `BatchEnvPool` 随机场接口快照，以及新任务接入最低标准。用户侧配置入口见 {doc}`域随机化 </zh_CN/1-user_guide/5-domain-randomization>`。
...
- [RL Infrastructure 开发标准](1-development-standard.md)
...
- Previous: [Development Standard](1-development-standard.md)
- Next: [Collaboration](2-collaboration.md)
