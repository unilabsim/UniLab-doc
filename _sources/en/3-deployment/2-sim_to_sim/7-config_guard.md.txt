...
3. **Before env creation**: the play entrypoints (rsl_rl / appo / sac / flashsac) call `resolve_sim2sim_config`, comparing the target config against the source run's contract snapshot field by field.
