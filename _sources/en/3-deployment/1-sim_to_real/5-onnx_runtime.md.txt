...
| SAC / FlashSAC | `src/unilab/scripts/train_sac.py` / `src/unilab/scripts/train_flashsac.py` | Playback writes `policy.onnx`; SAC and FlashSAC use `actor.as_export_module()` before export. |
