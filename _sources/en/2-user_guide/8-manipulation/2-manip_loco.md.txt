...
`src/unilab/conf/ppo/task/go2_arm_manip_loco/mujoco.yaml`, and the HIM-PPO owner is
...
HIM-PPO is configured by `src/unilab/conf/ppo_him/task/go2_arm_manip_loco/mujoco.yaml` and
